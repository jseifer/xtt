ModelStubbing.define_models do
  ...
  model User do
    stub :login => 'normal-user', :email => 'normal-user@example.com', :state => 'active',
      ...
      :activation_code => '8f24789ae988411ccf33ab0c30fe9106fab32e9b', :activated_at => current_time - 4.days, :group => all_stubs(:group)
  end
  
  model Project do
    stub :name => 'project', :billable => true, :group => all_stubs(:group)
  end
